...
\newcommand{\sourcecode}[1]{\texttt{\small #1}}
\newcommand{\figsource}[1]{\par\smallskip{\footnotesize\color{figray}\textit{Source: #1}}}
...
\input{sections/01_distinction_provenance}
\input{sections/02_dynamical_realization}
\input{sections/03_invertibility_structure}
\input{sections/04_description_fibres}
\input{sections/05_access_and_entropy}
\input{sections/06_provenance_demonstrations}
\input{sections/07_implications}
\input{sections/08_scope_and_open_problems}
\input{sections/09_conclusion}

\appendix
\input{sections/A_proofs}
\input{sections/B_methods}
\input{sections/C_result_ledger}
