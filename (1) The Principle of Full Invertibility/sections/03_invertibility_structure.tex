...
\figsource{\sourcecode{evidence/thesis\_verification.json}, \texttt{determinant\_factorization}.}
\end{figure}
...
\bottomrule
\end{tabular}
\figsource{\sourcecode{evidence/thesis\_verification.json}, \texttt{phase\_multiroot\_collision}.}
\end{table}
